...
- Save/load and validation: `docs/SERIALIZATION_AND_VALIDATION.md`
- Test strategy and quality gates: `docs/TEST_STRATEGY.md`
- Planning milestones: `docs/ROADMAP.md`
- Documentation governance: `docs/DOCS_POLICY.md`

## Legacy Material

Historical and superseded docs are moved to `docs/archive/`.
Those files are retained for context only and must not be treated as current behavior.
