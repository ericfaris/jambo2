...
const PEOPLE_DESIGNS: { design: CardDesignTemplate; copies: number }[] = [
  ...
  },
  {
    design: {
      ...
      type: 'people',
      description: 'Pick 2 wares from supply onto this card. Auction at 1g start bid. Placing player starts. Winner pays and takes wares.',
      interactionType: 'AUCTION',
      flowSteps: ['Select 2 ware types from supply', 'Alternate bids starting at 1g (placing player starts)', 'Winner pays and receives wares'],
      validation: [],
